...
Therfore, you'll have to initially use rsync one time, if you don't start with empty directories.
...
Therfore, you better don't use it for replicating log files still in use, for example.
